...
public class trueRecovery : Card
{
    //::::Important::::
    ...
    public override string Name { get; set; } = "True Recover_0";

    public override int BurnDamage { get; set; } = 0;

    public override string Description { get; } = "Mana cost: 5\nThis card raises your max HP by 3 points";

    public override void Effect(Enemy enemy)
    {
        ManagerManager.Resolve<CurrencyManager>().maxPlayerHP += 3;
    }
